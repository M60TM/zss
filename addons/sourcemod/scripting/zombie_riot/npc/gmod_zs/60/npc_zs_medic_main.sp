...
public void InfectedBattleMedic_ClotThink(int iNPC)
{
...
public Action InfectedBattleMedic_OnTakeDamage(int victim, int &attacker, int &inflictor, float &damage, int &damagetype, int &weapon, float damageForce[3], float damagePosition[3], int damagecustom)
{
...
public void InfectedBattleMedic_NPCDeath(int entity)
{
